...
## 6. Relación con `project_definition.md`

Ambos documentos están **alineados desde el 2026-08-23**: el alcance, los roles, los
requerimientos, el plan de fases y la distribución del equipo de `project_definition.md`
se actualizaron para reflejar lo definido aquí.

Ante cualquier duda de alcance, **prevalece este documento**.

Decisiones tomadas después de escribirlo, registradas como ADR en
[`docs/architecture/adr/`](../architecture/adr/):

| ADR                                                                                       | Afecta a                   |
| ----------------------------------------------------------------------------------------- | -------------------------- |
| [0004 — multi-tenant por columna + RLS](../architecture/adr/ADR-0004-multi-tenant.md)     | CU-01, CU-02, CU-03, CU-24 |
| [0005 — feature toggles con Unleash](../architecture/adr/ADR-0005-feature-toggles.md)     | transversal                |
| [0006 — motor de mapa tras un puerto](../architecture/adr/ADR-0006-motor-de-mapa.md)      | CU-06, CU-07, CU-08        |
| [0007 — Spec-Driven Development](../architecture/adr/ADR-0007-spec-driven-development.md) | metodología                |
